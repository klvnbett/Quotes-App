...
export class QuoteComponent implements OnInit {
 // title='THE BEST QUOTES OF ALL TIME';
  quotes:Quote[]=[
    ...
    new Quote(1,'Resentment','Having resentment in your heart is like taking poison and expecting the other person to die','Nelson mandela',new Date(2021,7,18),0),
    new Quote(2,'control','You have mission.you control your schedule, you control your life','Benjamin Franklin',new Date(2021, 7, 21),0)
  ];
